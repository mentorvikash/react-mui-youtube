...
function MuiMultiImageList() {
  return (
    <Stack spacing={4} width={500}>
      ...
      >
        {imageData.map((el) => (
          <ImageListItem key={el.title}>
            <img src={el.url} alt={el.title} loading="lazy" />
            <ImageListItemBar title={el.title.substring(0, 8)} />
          </ImageListItem>
        ))}
      </ImageList>
...
export default MuiMultiImageList;
